<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMain.Master" StylesheetTheme="ButtonSkin"
    AutoEventWireup="true" CodeBehind="EventList.aspx.cs" Inherits="Modikhana.Admin.EventList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="postedit" class="clearfix">
        ...
        <div class="section" id="GridDiv">
            <asp:GridView ID="GridEvents" Width="100%" AutoGenerateColumns="false" runat="server"
                DataKeyNames="ID" AllowPaging="True" BackColor="White" BorderColor="#DEDFDE"
                BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical"
                PageSize="20" OnPageIndexChanging="GridEvent_PageIndexChanging" OnRowDeleting="GridEvent_RowDeleting"
