<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMain.Master" AutoEventWireup="true" StylesheetTheme="ButtonSkin" CodeBehind="ContactDetailList.aspx.cs" Inherits="Modikhana.Admin.ContactDetailList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <div id="postedit" class="clearfix">
        <h2 class="ico_mug">
            List of Contact Detail</h2>
        ...
        <div class="section" id="GridDiv">
            <asp:GridView ID="GridContactDetail" Width="100%" AutoGenerateColumns="false" runat="server"
                DataKeyNames="ID" AllowPaging="True" BackColor="White" BorderColor="#DEDFDE"
                BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical"
                PageSize="20" onpageindexchanging="GridEvents_PageIndexChanging" 
                onrowdeleting="GridEvents_RowDeleting" onrowupdating="GridEvents_RowUpdating">
