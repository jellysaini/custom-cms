<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMain.Master" AutoEventWireup="true"
    StylesheetTheme="ButtonSkin" CodeBehind="ContactUs.aspx.cs" Inherits="Modikhana.Admin.ContactUs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="postedit" class="clearfix">
        ...
        <div class="section" id="GridDiv">
            <asp:GridView ID="GridContactUs" Width="100%" AutoGenerateColumns="false" runat="server"
                DataKeyNames="ID" AllowPaging="True" BackColor="White" BorderColor="#DEDFDE"
                BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical"
                PageSize="20" OnPageIndexChanging="GridContactUs_PageIndexChanging" OnRowDeleting="GridContactUs_RowDeleting"
                OnRowUpdating="GridContactUs_RowUpdating">
